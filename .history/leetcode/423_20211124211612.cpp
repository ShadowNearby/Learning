 ...
 * @LastEditors: js
 * @LastEditTime: 2021-11-24 21:16:12
...
public:
    string originalDigits(string s) {
        ...
        if(ch[15] > 0 && ch[0] > 1 && ch[3] > 0 && ch[13] > 0){
            ans += '3';
            --ch[15];
            --ch[0];
            --ch[0];
        ...
        if(ch[1] > 0 && ch[10] > 0 && ch[16] > 0 && ch[13] > 0){
            ans += '4';
            --ch[1];
            --ch[10];
            --ch[16];
        ...
        if(ch[1] > 0 && ch[4] > 0 && ch[17] > 0 && ch[0] > 0){
            ans += '5';
            --ch[1];
            --ch[4];
            --ch[17];
        ...
        if(ch[14] > 0 && ch[4] > 0 && ch[19] > 0){
            ans += '6';
            --ch[14];
            --ch[4];
            --ch[19];
        }
        if(ch[14] > 0 && ch[0] > 1 && ch[17] > 0 && ch[9] > 0){
            ans += '7';
            --ch[14];
            --ch[0];
            --ch[0];
        ...
        if(ch[0] > 0 && ch[4] > 0 && ch[2] > 0 && ch[3] > 0 && ch[15] > 0){
            ans += '8';
            --ch[0];
            --ch[4];
            --ch[2];

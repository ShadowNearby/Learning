 ...
 * @LastEditors: js
 * @LastEditTime: 2021-11-24 21:24:36
...
public:
    string originalDigits(string s) {
        ...
        count[6] = ch[19];
        count[8] = ch[2];
        count[3] = ch[3] - count[8];
        count[5] = ch[1] - count[4];
        count[7] = ch[14] - count[6];
        count[1] = ch[10] - count[0] - count[2] - count[4];
        count[9] = ch[4] - count[5] - count[6] - count[8];
        for (int i = 0; i < 10; ++i){
            while()
        }
            return ans;
